...
export function SalesPlaybookSettings({
  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 text-sm text-[#6B6459] py-8">
  ...
  return (
    <div>
      ...
      {playbook ? (
          ...
          <div className="flex items-start justify-between gap-3 flex-wrap">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-[#6B6459] mt-0.5" style={{ fontFamily: "'IBM Plex Mono', monospace" }}>
        ...
        <div className="rounded-2xl border p-5 mb-6" style={{ borderColor: "#E7E5DE", backgroundColor: "#FAFAF7" }}>
      ...
      {versions.length > 0 && (
        <div className="mb-8">
          ...
          <div className="flex flex-col gap-2">
            {versions.map((item) => (
              <div key={item.version} className="flex items-center justify-between gap-3 px-3 py-2.5 rounded-xl border border-[#E7E5DE] text-sm">
      ...
      <div className="flex flex-wrap gap-1.5 mb-4">
        {FILTERS.map((item) => (
          <button
            ...
            style={{
              borderColor: filter === item.key ? "#151515" : "#E7E5DE",
              backgroundColor: filter === item.key ? "#151515" : "#fff",
      ...
      {visibleCards.length === 0 ? (
        ...
        <div className="flex flex-col gap-3">
          {visibleCards.map((card) => {
            ...
            return (
              <div key={key} className="p-4 rounded-xl border border-[#E7E5DE]">
                <div className="flex items-start justify-between gap-3 flex-wrap">
                ...
                {showReviewActions && (
                  <div className="flex items-center gap-2 mt-4">
                    ...
                    <button
                      ...
                      className="text-xs font-medium px-3 py-2 rounded-lg border border-[#E7E5DE] flex items-center gap-1.5 disabled:opacity-50"
                    >
                      <X size={12} />
                      Reject
                    </button>
                ...
                {confirmation && (
                  <div className="mt-4 p-3 rounded-lg border" style={{ borderColor: "#E8CFAF", backgroundColor: "#FFF8EE" }}>
                    <p className="text-sm">
                    ...
                    <p className="text-xs text-[#8A561B] mt-1.5">{confirmation.warning}</p>
                    <div className="flex flex-wrap items-center gap-2 mt-3">
                      ...
                      <button
                        ...
                        className="text-xs font-medium px-3 py-2 rounded-lg border border-[#E7E5DE] disabled:opacity-50"
                      >
                        Cancel
                      </button>
                    </div>
