    ...
    <div className="min-h-screen w-full flex" style={{ backgroundColor: "#F7F6F2", fontFamily: "'Inter', sans-serif", color: "#171A21" }}>
      ...
      <main className="flex-1 min-w-0 flex flex-col">
        <header className="px-6 md:px-8 py-4 border-b border-[#E7E5DE]">
          ...
          <p className="text-sm text-[#6B7280] mt-0.5">Your Atelier subscription — manage it yourself, any time.</p>
        </header>
            ...
            <>
              ...
              {!needsPlanSelection(status) && (
                <div className="bg-white rounded-2xl border border-[#E7E5DE] p-6 mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <div className="text-sm text-[#6B7280] mb-1">Current plan</div>
              ...
              {needsPlanSelection(status) && (
                <>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    {PLANS.map((p) => (
                      <div key={p.id} className="bg-white rounded-2xl border border-[#E7E5DE] p-6 flex flex-col">
                        <div className="text-sm font-medium text-[#3A3EA6] mb-1">{p.name}</div>
                        <div className="text-2xl mb-2" style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600 }}>{p.price}</div>
                        <p className="text-sm text-[#6B7280] mb-4 leading-relaxed">{p.desc}</p>
                  ...
                  <p className="text-xs text-[#9AA1AC] mt-4">
